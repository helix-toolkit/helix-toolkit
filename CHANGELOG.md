...
2. Supports absolute 3D position mode in ScreenSpacedNode. Helps to have multiple coordinate system in world space and zooming does not affects the coordinate system size. See [CustomViewCubeDemo](/Source/Examples/WPF.SharpDX/CustomViewCubeDemo) for details. Ref #1165 (WPF.SharpDX/UWP/Core)
