...
public static class ViewportExtensions
{
    ...
    public static Matrix GetViewProjectionMatrix3D(this Viewport3DX viewport)
    {
        return viewport.GetViewProjectionMatrix();
    }
    /// <summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Matrix GetScreenViewProjectionMatrix3D(this Viewport3DX viewport)
    {
        return viewport.GetScreenViewProjectionMatrix();
    }
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Matrix GetViewportMatrix3D(this Viewport3DX viewport)
    {
    ...
    public static readonly HitTestResult[] EmptyHits = Array.Empty<HitTestResult>();
    ...
    public static void SaveScreen(this Viewport3DX view, string fileName, Direct2DImageFormat format)
    {
        ...
        if (view.RenderHost != null && view.RenderHost.IsRendering)
        {
            ...
            if (view.RenderHost.EffectsManager is not null)
            {
    ...
    {
        if (viewport.Camera is not PerspectiveCamera pcamera || !viewport.IsChangeFieldOfViewEnabled)
        {
            return;
        }
        ...
        newLookDirection = Vector3.Normalize(newLookDirection);
