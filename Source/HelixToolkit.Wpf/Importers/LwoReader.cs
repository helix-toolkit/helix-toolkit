...
/// </remarks>
public sealed class LwoReader : ModelReader
{
    /// <summary>
    ...
    public IList<MeshBuilder> Meshes { get; private set; } = new List<MeshBuilder>();

    /// <summary>
    /// Gets the surfaces.
    /// </summary>
    /// <value>The surfaces.</value>
    public IList<string> Surfaces { get; private set; } = new List<string>();

    /// <summary>
    /// Gets or sets Points.
    /// </summary>
    private IList<Point3D> Points { get; set; } = new List<Point3D>();
