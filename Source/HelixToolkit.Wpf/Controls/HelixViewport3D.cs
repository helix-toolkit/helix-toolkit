...
public class HelixViewport3D : ItemsControl, IHelixViewport3D
{
    ...
    public static readonly DependencyProperty LimitFPSProperty =
        ...
        {
            if (d is HelixViewport3D h)
            {
                h.limitFPS = (bool)e.NewValue;
            }
        }));
    ...
    public ProjectionCamera? Camera
    {
        ...
        set
        {
            ...
            if (this.currentCamera is not null)
            {
                this.currentCamera.Changed += this.CameraPropertyChanged;
            }
        }
    ...
    private void UpdateCursorPosition(Point pt)
    {
        ...
        if (this.Viewport.Point2DtoPoint3D(pt, out Point3D cursorNearPlanePoint, out Point3D cursorFarPlanePoint))
        {
    ...
    {
        this.CameraInfo = this.Camera?.GetInfo() ?? string.Empty;
    }
    ...
    private void UpdateFieldOfViewInfo()
    {
        ...
        this.FieldOfViewText = pc != null ? string.Format("FoV ∠ {0:0}°", pc.FieldOfView) : string.Empty;
    }
