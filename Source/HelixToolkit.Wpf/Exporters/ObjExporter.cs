...
/// </remarks>
public sealed class ObjExporter : Exporter<ObjExporter.ObjWriters>
{
    /// <summary>
    ...
    /// </summary>
    public sealed class ObjWriters
    {
        /// <summary>
        /// Gets or sets the object file writer.
        /// </summary>
        public required StreamWriter ObjWriter { get; set; }

        /// <summary>
        /// Gets or sets the material file writer.
        /// </summary>
        public required StreamWriter MaterialsWriter { get; set; }
    }
}
