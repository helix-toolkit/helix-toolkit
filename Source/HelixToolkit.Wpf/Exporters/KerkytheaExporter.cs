...
/// </summary>
public sealed class KerkytheaExporter : Exporter<KerkytheaExporter.KerkytheaWriter>
{
    /// <summary>
    ...
    protected override void ExportCamera(KerkytheaWriter writer, Camera c)
    {
        ...
        {
            ThrowHelper.ThrowInvalidOperationException("Only perspective cameras are supported.");
            return;
        }
    ...
    {
        // reuse textures
        if (writer.TryGetTexture(brush, out string? textureFile))
        {
            return textureFile;
        }

        string filename = name + ".png";
        string path = this.TexturePath is null ? filename : Path.Combine(this.TexturePath, filename);
        ...
        string? nkfile = null)
    {
        ...
        writer.WriteParameter("N-K File", nkfile ?? string.Empty);
        writer.WriteEndObject();
    }
    ...
    /// </summary>
    public sealed class KerkytheaWriter
    {
        /// <summary>
        /// The writer
        /// </summary>
        ...
        public bool TryGetTexture(Brush brush, [MaybeNullWhen(false)] out string textureFile)
        {
