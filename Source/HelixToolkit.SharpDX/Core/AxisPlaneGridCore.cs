...
public class AxisPlaneGridCore : RenderCore
{
    ...
    protected override bool OnAttach(IRenderTechnique? technique)
    {
        ...
        samplerSlot = DefaultShaderPass?.PixelShader.SamplerMapping.TryGetBindSlot(DefaultSamplerStateNames.ShadowMapSampler) ?? 0;
        shadowMapSlot = DefaultShaderPass?.PixelShader.ShaderResourceViewMapping.TryGetBindSlot(DefaultBufferNames.ShadowMapTB) ?? 0;
