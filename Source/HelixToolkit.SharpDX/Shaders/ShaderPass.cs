...
public sealed class ShaderPass : DisposeObject
{
    ...
    public ShaderBase? GetShader(ShaderStage type)
    {
        return type switch
        {
            ...
            ShaderStage.Compute => ComputeShader,
            ShaderStage.Hull => HullShader,
            ShaderStage.Domain => DomainShader,
            ShaderStage.Geometry => GeometryShader,
            _ => null,
        };
    }
    /// <summary>
    ...
    public void SetState(BlendStateDescription? blendStateDesc)
    {
        ...
        blendState = blendStateDesc != null ?
            effectsManager?.StateManager?.Register(blendStateDesc.Value) ?? BlendStateProxy.Empty : BlendStateProxy.Empty;
    }
    /// <summary>
    /// Sets the state.
    /// </summary>
    ...
    public void SetState(DepthStencilStateDescription? depthStencilStateDesc)
    {
        ...
        depthStencilState = depthStencilStateDesc != null ?
            effectsManager?.StateManager?.Register(depthStencilStateDesc.Value) ?? DepthStencilStateProxy.Empty : DepthStencilStateProxy.Empty;
    }
    /// <summary>
    /// Sets the state.
    /// </summary>
    ...
    public void SetState(RasterizerStateDescription? rasterizerStateDesc)
    {
        ...
        rasterState = rasterizerStateDesc != null ?
            effectsManager?.StateManager?.Register(rasterizerStateDesc.Value) ?? RasterizerStateProxy.Empty : RasterizerStateProxy.Empty;
    }
