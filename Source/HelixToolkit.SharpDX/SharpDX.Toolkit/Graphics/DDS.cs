...
internal class DDS
{
    ...
    public struct PixelFormat
    {
        ...
        public static readonly PixelFormat DXT2 = new(PixelFormatFlags.FourCC, new FourCC('D', 'X', 'T', '2'), 0, 0, 0, 0, 0);

        public static readonly PixelFormat DXT3 = new(PixelFormatFlags.FourCC, new FourCC('D', 'X', 'T', '3'), 0, 0, 0, 0, 0);

        public static readonly PixelFormat DXT4 = new(PixelFormatFlags.FourCC, new FourCC('D', 'X', 'T', '4'), 0, 0, 0, 0, 0);
        ...
        public static readonly PixelFormat X8B8G8R8 = new(PixelFormatFlags.Rgb, 0, 32, 0x000000ff, 0x0000ff00, 0x00ff0000, 0x00000000);
        ...
        public static readonly PixelFormat R8G8B8 = new(PixelFormatFlags.Rgb, 0, 24, 0x00ff0000, 0x0000ff00, 0x000000ff, 0x00000000);
        ...
        public static readonly PixelFormat DX10 = new(PixelFormatFlags.FourCC, new FourCC('D', 'X', '1', '0'), 0, 0, 0, 0, 0);
    }
