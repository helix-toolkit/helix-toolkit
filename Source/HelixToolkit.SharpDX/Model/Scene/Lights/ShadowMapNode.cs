...
public class ShadowMapNode : SceneNode
{
    ...
    public Size2 Resolution
    {
        get
        {
            if (RenderCore is ShadowMapCore core)
            {
                return new Size2(core.Width, core.Height);
            }
        ...
        set
        {
            if (RenderCore is ShadowMapCore core)
            {
                core.Width = value.Width;
                core.Height = value.Height;
            }
        }
    }
    ...
    protected override bool CanRender(RenderContext context)
    {
        if (RenderCore is ShadowMapCore core)
        {
            core.NeedRender = base.CanRender(context) && context.RenderHost.IsShadowMapEnabled;
        }
