...
using ComputeShader = HelixToolkit.SharpDX.Shaders.ComputeShader;
using DomainShader = HelixToolkit.SharpDX.Shaders.DomainShader;
using GeometryShader = HelixToolkit.SharpDX.Shaders.GeometryShader;
using HullShader = HelixToolkit.SharpDX.Shaders.HullShader;
...
public partial class DeviceContextProxy
{
    ...
    public void SetShader(Shaders.VertexShader shader, bool bindConstantBuffer = true)
    {
    ...
    /// <param name="bindConstantBuffer"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetShader(Shaders.HullShader shader, bool bindConstantBuffer = true)
    {
    ...
    /// <param name="bindConstantBuffer"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetShader(Shaders.DomainShader shader, bool bindConstantBuffer = true)
    {
    ...
    /// <param name="bindConstantBuffer"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetShader(Shaders.GeometryShader shader, bool bindConstantBuffer = true)
    {
    ...
    /// <param name="bindConstantBuffer"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetShader(Shaders.PixelShader shader, bool bindConstantBuffer = true)
    {
    ...
    /// <param name="bindConstantBuffer"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetShader(Shaders.ComputeShader shader, bool bindConstantBuffer = true)
    {
