...
public abstract class DX11RenderBufferProxyBase : DisposeObject
{
    ...
    public DX11RenderBufferProxyBase(IDeviceResources deviceResource, bool useDepthStencilBuffer = true)
    {
        ...
        deviceContextPool = Device is null ? null : new DeviceContextPool(Device);
    ...
    private void CreateNonMSAADepthStencilBuffer(int width, int height)
    {
        if (HasMSAA)
        {
            ...
            depthStencilBufferNoMSAA = Device is null ? null : new ShaderResourceViewProxy(Device, depthdesc);
    ...
    {
        if (DeviceContext2D is not null)
        {
    ...
    protected virtual SampleDescription GetMSAASampleDescription()
    {
        ...
        if (MSAA != MSAALevel.Disable && Device is not null)
        {
            do
            {
        ...
        out ShaderResourceViewProxy? colorBuffer, out ShaderResourceViewProxy? depthStencilBuffer)
    {
        ...
        colorBuffer = Device is null ? null : new ShaderResourceViewProxy(Device, colordesc);
        ...
        if (createDepthStencilBuffer)
        {
            ...
            depthStencilBuffer = Device is null ? null : new ShaderResourceViewProxy(Device, depthdesc);
