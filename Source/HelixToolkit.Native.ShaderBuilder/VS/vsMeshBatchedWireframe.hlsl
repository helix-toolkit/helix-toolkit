#ifndef VSMESHBATCHEDWIREFRAME_HLSL
#define VSMESHBATCHEDWIREFRAME_HLSL
...
PSWireframeInput main(VSInputBatched input)
{
   ...
   // }
    ...
    {
        float2 t = mul(float2x4(uvTransformR1, uvTransformR2), float4(input.t.xy, 0, 1)).xy;
