...
#endif
{
    ...
    public abstract class MaterialGeometryNode : GeometryNode
    {
        ...
        public bool RenderDiffuseMap
        {
            ...
            set
            {
                (RenderCore as IMaterialRenderParams).RenderDiffuseMap = value;
            }
        }
        ...
        public bool RenderNormalMap
        {
            ...
            set
            {
                (RenderCore as IMaterialRenderParams).RenderNormalMap = value;
            }
        }
        ...
        public bool RenderDiffuseAlphaMap
        {
            ...
            set
            {
                (RenderCore as IMaterialRenderParams).RenderDiffuseAlphaMap = value;
            }
        }
        ...
        public bool RenderDisplacementMap
        {
            get
            {
                return (RenderCore as IMaterialRenderParams).RenderDisplacementMap;
            }
            set
            {
                (RenderCore as IMaterialRenderParams).RenderDisplacementMap = value;
            }
        }
