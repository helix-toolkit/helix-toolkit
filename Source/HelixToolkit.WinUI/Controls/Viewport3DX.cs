...
namespace HelixToolkit.WinUI
{
    ...
    public static class ViewportPartNames
    {
        ...
        public const string PART_DummyButton = "PART_DummyButton";
    }
    ...
    [TemplatePart(Name = ViewportPartNames.PART_DummyButton, Type = typeof(Button))]
    public partial class Viewport3DX : Control, IViewport3DX
    {
        ...
        public Viewport3DX()
        {
            ...
            this.Loaded += Viewport3DX_Loaded;
        ...
        {
            var dpi = sender.RasterizationScale;
            if (hostPresenter != null && hostPresenter.Content is SwapChainRenderHost host)
            {
                host.DpiScale = (float)dpi;
            }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (hostPresenter != null)
            {
                ...
                var dpi = XamlRoot.RasterizationScale; // *** DisplayInformation.GetForCurrentView().RawPixelsPerViewPixel;
                host.DpiScale = (float)dpi;
            ...
            /*
            dummyButton = GetTemplateChild(ViewportPartNames.PART_DummyButton) as Button;
            if (dummyButton != null)
            {
