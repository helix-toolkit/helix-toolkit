...
namespace HelixToolkit.WinUI
{
    ...
    public class InputController
    {
        ...
        protected virtual bool IsStartRotate(ExpPointerPointProperties properties)
        {
            return properties.IsRightButtonPressed;
        }

        protected virtual bool IsStartPan(ExpPointerPointProperties properties)
        {
            return properties.IsLeftButtonPressed;
        }

        protected virtual bool IsStartZoomExtends(ExpPointerPointProperties properties)
        {
            return false;
        }

        protected virtual bool IsStartZoom(ExpPointerPointProperties properties)
        {
            return properties.MouseWheelDelta != 0;
        }

        protected virtual bool IsStartZoomRectangle(ExpPointerPointProperties properties)
        {
            return false;
        }

        protected virtual bool IsResetCamera(ExpPointerPointProperties properties)
        {
            return false;
        }

        protected virtual bool IsChangeLookAt(ExpPointerPointProperties properties)
        {
            return false;
        }

        protected virtual bool IsChangeFieldOfView(ExpPointerPointProperties properties)
        {
            return false;
        }
        #endregion
