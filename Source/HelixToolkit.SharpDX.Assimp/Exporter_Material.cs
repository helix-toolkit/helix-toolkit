...
public partial class Exporter
{
    ...
    /// <returns></returns>
    protected virtual bool GetMaterialFromNode(HxScene.SceneNode node, [NotNullWhen(true)] out MaterialCore? material)
    {
    ...
    private static TextureWrapMode ToAssimpAddressMode(TextureAddressMode mode)
    {
        return mode switch
        {
            ...
            TextureAddressMode.Mirror => TextureWrapMode.Mirror,
            TextureAddressMode.Wrap => TextureWrapMode.Wrap,
