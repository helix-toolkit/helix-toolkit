...
namespace HelixToolkit.SharpDX.Wpf
{
    ...
    public partial class Viewport3DX : ItemsControl, IRenderable
    {
        ...
        {
            AdornerLayer myAdornerLayer = AdornerLayer.GetAdornerLayer(this.Canvas);
        ...
        public void ShowTargetAdorner(Point position)
        {
            ...
            AdornerLayer myAdornerLayer = AdornerLayer.GetAdornerLayer(this.Canvas);
            this.targetAdorner = new TargetSymbolAdorner(this.Canvas, position);
        ...
        public void ShowZoomRectangle(Rect rect)
        {
            ...
            var myAdornerLayer = AdornerLayer.GetAdornerLayer(this.Canvas);
            this.rectangleAdorner = new RectangleAdorner(
                this.Canvas, rect, Colors.LightGray, Colors.Black, 3, 1, 10, DashStyles.Solid);
        ...
        {
            this.FpsCounter.AddFrame(StopWatch.Elapsed);
