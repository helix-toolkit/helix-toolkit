...
public partial class Viewport3DX
{
    ...
    public static readonly DependencyProperty BackgroundColorProperty = DependencyProperty.Register(
        ...
        {
            var host = ((Viewport3DX)s).renderHostInternal;

            if (host is not null)
            {
                host.ClearColor = ((UIColor)e.NewValue).ToColor4();
            }
        }));
    ...
    public static readonly DependencyProperty MSAAProperty = DependencyProperty.Register("MSAA", typeof(MSAALevel), typeof(Viewport3DX),
        new PropertyMetadata(MSAALevel.Disable, (d, e) =>
        {
            if (d is not Viewport3DX viewport)
            {
                return;
    ...
    public static readonly DependencyProperty EnableSharedModelModeProperty
        = DependencyProperty.Register("EnableSharedModelMode", typeof(bool), typeof(Viewport3DX), new PropertyMetadata(false, (d, e) =>
        {
            if (d is not Viewport3DX viewport)
            {
                return;
