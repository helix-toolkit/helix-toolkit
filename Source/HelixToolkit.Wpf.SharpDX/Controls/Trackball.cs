...
public class Trackball
{
    ...
    private ScaleTransform3D _scale = new();
    private AxisAngleRotation3D _rotation = new();
    private TranslateTransform3D _translate = new();
    ...
    private void Look(Point currentPosition)
    {
        ...
        var delta = new Quaternion(axis.ToVector3(), (float)-angle);

        // Get the current orientation from the RotateTransform3D
        var r = _rotation;
        var q = new Quaternion(_rotation.Axis.ToVector3(), (float)_rotation.Angle);
