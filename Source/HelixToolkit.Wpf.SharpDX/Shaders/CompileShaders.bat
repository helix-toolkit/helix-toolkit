...
"C:\Program Files (x86)\Microsoft DirectX SDK (June 2010)\Utilities\bin\x64\fxc" /T fx_5_0 /I ./../ /Fo ..\Resources\_default.bfx Effects.fx
"C:\Program Files (x86)\Microsoft DirectX SDK (June 2010)\Utilities\bin\x64\fxc" /T fx_5_0 /I ./../ /Fo ..\Resources\_Tessellation.bfx TessellationEffects.fx
