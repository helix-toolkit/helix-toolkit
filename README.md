...
#### 2025-08-17
[v2.27.1](https://github.com/helix-toolkit/helix-toolkit/releases/tag/v2.27.1) releases are available on nuget. [Release Note](/CHANGELOG.md)

:bangbang: HelixToolkit v2 is in maintainance mode. No more new feature will be added. New version will be released only for critical bug fixes.
Moving forward, our focus will shift to the development of v3.
